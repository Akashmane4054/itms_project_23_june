...
public interface UserTokenRepository extends JpaRepository<UserToken, String> {
	...
	@Query("SELECT u FROM UserToken u WHERE u.empId = :empId AND u.loggedIn = :loggedIn")
	UserToken findByEmpIdAndLoggedIn(@Param("empId") String empId, @Param("loggedIn") Boolean loggedIn);
